    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/admin/Desktop/Techsaksham/P2-Attendance-Management-System-using-Face-Recognition-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Users/admin/Desktop/Techsaksham/P2-Attendance-Management-System-using-Face-Recognition-main\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            detector = cv2.CascadeClassifier(r'C:\Users\admin\Desktop\Techsaksham\P2-Attendance-Management-System-using-Face-Recognition-main\haarcascade_frontalface_default.xml')
            ...
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite("C:/Users/admin/Desktop/Techsaksham/P2-Attendance-Management-System-using-Face-Recognition-main/TrainingImage/ " + Name + "." + Enrollment + '.' + str(sampleNum) + ".jpg",
                                gray)
            ...
            with open(r'C:\Users\admin\Desktop\Techsaksham\P2-Attendance-Management-System-using-Face-Recognition-main\StudentDetails\StudentDetails.csv', 'a+') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                harcascadePath = "C:/Users/admin/Desktop/Techsaksham/P2-Attendance-Management-System-using-Face-Recognition-main/haarcascade_frontalface_default.xml"
                faceCascade = cv2.CascadeClassifier(harcascadePath)
                df = pd.read_csv("C:/Users/admin/Desktop/Techsaksham/P2-Attendance-Management-System-using-Face-Recognition-mainStudentDetails\StudentDetails.csv")
                cam = cv2.VideoCapture(0)
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='1234', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/admin/Desktop/Techsaksham/P2-Attendance-Management-System-using-Face-Recognition-main/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\admin\Desktop\Techsaksham\P2-Attendance-Management-System-using-Face-Recognition-main\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'Paras':
            if password == 'Paras123':
                ...
                cs = 'C:/Users/admin/Desktop/Techsaksham/P2-Attendance-Management-System-using-Face-Recognition-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
def trainimg():
    ...
    global detector
    detector = cv2.CascadeClassifier("C:/Users/admin/Desktop/Techsaksham/P2-Attendance-Management-System-using-Face-Recognition-main/haarcascade_frontalface_default.xml")
    try:
        global faces, Id
